...
public class HealthInsuranceController {
    ...
    @PostMapping("/api/v1/healthinsurance")
    ...
    @PutMapping("/api/v1/healthinsurance/{id}")
    ...
    @DeleteMapping("/api/v1/healthinsurance/{id}")
    ...
    @GetMapping("/api/v1/healthinsurance/policytypes")
